...
const StargazersCell = ({rowIndex, data, col, ...props}) => (
    <Cell {...props}>
        <span className="pull-right">{data[rowIndex][col].toLocaleString()} <i
            className="fa fa-star repo_fa-star"/> </span>
    </Cell>
);
            ...
            <div className="container-fluid">
                ...
                <nav>
                    <ul className="pager">
                        ...
                        <li className={'pager-next' + (repos.length > 0 ? '' : ' disabled')}><a href="#"
                                                                                                onClick={this.handleNextPageClick}>Next</a>
                        </li>
                    </ul>
                </nav>
